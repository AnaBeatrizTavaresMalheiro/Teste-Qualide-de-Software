...
class TestCalculadora(unittest.TestCase):
    ...
    def test_divisao_por_zero(self):
        ...
        # * Sugestão de melhoria: Aqui esperamos um erro ao tentar dividir por número muito pequeno
        with self.assertRaises(ValueError):  
            calc.dividir(10, 1e-301)  # Tentando dividir por número extremamente pequeno
    ...
    def test_mensagens_erro(self):
        ...
        try:
            ...
            self.assertEqual(str(e), "Divisão por zero não é permitida")
    ...
    #Teste Adicional para aumentar a cobertura
